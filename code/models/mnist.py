...
class CNN_MNIST_RELU_drop_sched(nn.Module):
  def __init__(self):
    super(CNN_MNIST_RELU_drop_sched,self).__init__()
    self.relu = nn.ReLU()
    self.conv1 = nn.Conv2d(1,8,3,1)
    self.conv2 = nn.Conv2d(8,16,3,1)
    self.conv3 = nn.Conv2d(16,16,3,1)
...
class CNN_MNIST_SWISH_drop_sched(nn.Module):
  def __init__(self):
    super(CNN_MNIST_SWISH_drop_sched,self).__init__()
    self.silu = nn.SiLU()
    self.conv1 = nn.Conv2d(1,8,3,1)
    self.conv2 = nn.Conv2d(8,16,3,1)
    self.conv3 = nn.Conv2d(16,16,3,1)
...
class CNN_MNIST_TANH_drop_sched(nn.Module):
  def __init__(self):
    super(CNN_MNIST_TANH_drop_sched,self).__init__()
    self.tanh = nn.Tanh()
    self.conv1 = nn.Conv2d(1,8,3,1)
    self.conv2 = nn.Conv2d(8,16,3,1)
    self.conv3 = nn.Conv2d(16,16,3,1)
